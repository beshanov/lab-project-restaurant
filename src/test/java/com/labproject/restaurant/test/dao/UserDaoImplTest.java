...
public class UserDaoImplTest {
    ...
    private UserEntity createNewUserEntity(String login) {
    ...
    public void testInsert() {
        ...
        UserEntity newUser = createNewUserEntity(login);
    ...
    public void testUpdate() {
        ...
        long id = createNewUser(login);
        UserEntity user = createNewUserEntity(login);
        user.setId(id);
        user.setLogin("newLogin");
        userDao.update(user);
        UserEntity updatedUser = userDao.getById(id);
    ...
    public void testDelete() {
        ...
        long id = createNewUser(login);
        try (Connection conn = dataSource.getConnection()) {
            UserEntity userForDelete = createNewUserEntity(login);
